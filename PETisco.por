...
programa {
  ...
  funcao ProgramaPrincipal() {
	...
	se ((produto_selecionado <= 10) e (produto_selecionado != 0)) {
      	contabiliza(valores)
      	pagamento(valorTotal)
	      se (faturaNota == verdadeiro) {
	        notaFiscal(produtos, valores)
	      }
	} senao {
	   g.fechar_janela()
	}
  ...
  funcao notaFiscal(cadeia produtos[], real valores[]) {
    cadeia nomeCliente
 ...
 * 
 * @POSICAO-CURSOR = 9641; 
 * @DOBRAMENTO-CODIGO = [27, 41, 62, 79, 86, 90, 100, 108];
 * @PONTOS-DE-PARADA = ;
